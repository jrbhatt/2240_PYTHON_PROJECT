...
// Class: Main
// Description: Runs a Snake game using JavaFX using instances of Snake and Food classes for game
// objects and an instance of Directions class for gameplay logic. High scores are tracked and displayed in a SQLite database by calling DatabaseControl, HighScoreBox and inserted points and with instructions for the player using  home class
public class Main extends Application{
    ...
    // Functiion that launches JavaFx
    ...
    //Method: getGame
    // Descripton: returns the Pane of the game's layout and initializes the game animation
